...
_fixed_ipaths = [
    ...
    "cmn/target_if/spatial_reuse/inc",
    ...
    "components/dp/core/inc",
    "components/dp/core/src",
    "components/dp/dispatcher/inc",
    "components/dsc/inc",
    "components/dsc/src",
    "components/dsc/test",
    ...
    "components/spatial_reuse/dispatcher/inc",
    ...
    "components/target_if/denylist_mgr/inc",
...
_conditional_srcs = {
    ...
    "CONFIG_BERYLLIUM": {
        True: [
            ...
            "cmn/dp/wifi3.0/dp_rings_main.c",
            "cmn/dp/wifi3.0/dp_rx_err.c",
            "cmn/dp/wifi3.0/dp_rx_tid.c",
    ...
    "CONFIG_FEATURE_DENYLIST_MGR": {
        True: [
            "components/denylist_mgr/core/src/wlan_dlm_core.c",
            "components/denylist_mgr/core/src/wlan_dlm_main.c",
            "components/denylist_mgr/dispatcher/src/wlan_dlm_tgt_api.c",
            "components/denylist_mgr/dispatcher/src/wlan_dlm_ucfg_api.c",
            "components/target_if/denylist_mgr/src/target_if_dlm.c",
        ],
    },
    ...
    "CONFIG_FEATURE_WDS": {
        True: [
            ...
            "cmn/wmi/src/wmi_unified_wds_api.c",
            "cmn/wmi/src/wmi_unified_wds_tlv.c",
        ],
    },
    ...
    "CONFIG_RHINE": {
        True: [
            ...
            #ifeq (y,$(filter y,$(CONFIG_LITHIUM) $(CONFIG_BERYLLIUM) $(CONFIG_RHINE)))
            "cmn/dp/cmn_dp_api/dp_ratetable.c",
            "cmn/dp/wifi3.0/rh/dp_rh.c",
            "cmn/dp/wifi3.0/rh/dp_rh_htt.c",
            "cmn/dp/wifi3.0/rh/dp_rh_rx.c",
            "cmn/dp/wifi3.0/rh/dp_rh_tx.c",
            "cmn/hal/wifi3.0/hal_reo.c",
            "cmn/hal/wifi3.0/hal_srng.c",
            "cmn/wlan_cfg/wlan_cfg.c",
            "components/dp/core/src/wlan_dp_prealloc.c",
    ...
    "CONFIG_RX_FISA": {
        True: [
            ...
            #TODO: check LITHIUM/BERYLLIUM/RHINE dependency
            "cmn/hal/wifi3.0/hal_rx_flow.c",
        ],
    },
    "CONFIG_SMP": {
        True: [
    ...
    "CONFIG_WIFI_POS_CONVERGED": {
        True: [
            ...
            "cmn/os_if/linux/wifi_pos/src/os_if_wifi_pos_utils.c",
            "cmn/os_if/linux/wifi_pos/src/wlan_cfg80211_wifi_pos.c",
            "cmn/target_if/wifi_pos/src/target_if_wifi_pos.c",
            "cmn/target_if/wifi_pos/src/target_if_wifi_pos_rx_ops.c",
            "cmn/target_if/wifi_pos/src/target_if_wifi_pos_tx_ops.c",
    ...
    "CONFIG_WLAN_FEATURE_11BE_MLO": {
        True: [
            ...
            "cmn/umac/mlo_mgr/src/wlan_mlo_mgr_op.c",
    ...
    "CONFIG_WLAN_FEATURE_MCC_QUOTA": {
        True: [
            "components/p2p/core/src/wlan_p2p_mcc_quota.c",
    ...
    "CONFIG_WLAN_FEATURE_PEER_TXQ_FLUSH_CONF": {
        True: [
...
def _define_module_for_target_variant_chipset(target, variant, chipset):
    ...
    ddk_module(
        ...
        local_defines = ["OPLUS_FEATURE_WIFI_BDF", "OPLUS_FEATURE_WIFI_MAC", "OPLUS_FEATURE_WIFI_FTM", "OPLUS_FEATURE_WIFI_DCS_SWITCH", "OPLUS_BUG_STABILITY", "OPLUS_FEATURE_WIFI_VENDOR_FT", "OPLUS_FEATURE_CONN_POWER_MONITOR", "OPLUS_FEATURE_WIFI_BEAM_SWITCH", "OPLUS_FEATURE_SOFTAP_DCS_SWITCH"],
