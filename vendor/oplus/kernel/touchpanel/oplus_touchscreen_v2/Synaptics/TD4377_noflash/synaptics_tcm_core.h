...
#ifdef TPD_DEVICE
#undef TPD_DEVICE
#define TPD_DEVICE "synaptics,td4377"
#else
#define TPD_DEVICE "synaptics,td4377"
#endif

#define SYNDRIVER_NAME     "td4377"
...
int syna_black_screen_test(struct black_gesture_test *p,
...
struct syna_tcm_hcd {
	...
	bool tp_fw_update_headfile;
	bool tp_fw_update_first;
	bool tp_fw_update_parse;
	int tp_irq_state;
